...
### Main findings
- TheTom TurboQuant fork did **not** show a large speed/size advantage over upstream for this exact `35B + q8_0/q8_0 + single V100` case, but gives KV tq compression for future use.
